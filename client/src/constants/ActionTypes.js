...
export const ADD_CODESMELLS = 'ADD_CODESMELLS';
export const ADD_DEFAULT_CODESMELLS = 'ADD_DEFAULT_CODESMELLS';
export const ADD_CODESMELLS_REQUEST = 'ADD_CODESMELLS_REQUEST';
